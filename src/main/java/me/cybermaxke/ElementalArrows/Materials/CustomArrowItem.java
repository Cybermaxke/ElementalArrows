...
public abstract class CustomArrowItem extends GenericCustomItem {
	...
	public CustomArrowItem(Plugin plugin, String name, String texture) {
		...
		if (!this.file.exists()) {
			...
			this.permission = new Permission(this.config.getString("Permission"), PermissionDefault.OP);
	...
	public boolean hasUsePermission(SpoutPlayer player) {
		return permission == null ? true : player.hasPermission(this.permission);
	}

	public void setUsePermission(Permission permission) {
