 ...
 * 
 */
package me.cybermaxke.elementalarrows.spout.api.protocol;
...
public class ElementalFireworkProtocol extends ObjectEntityProtocol {
	...
	public List<Parameter<?>> getSpawnParameters(Entity entity) {
		...
		params.add(new Parameter<ItemStack>(Parameter.TYPE_ITEM, EFFECT_INDEX, entity.add(ElementalFireworks.class).getItem()));
		return params;
	}
}