 ...
 */
package me.cybermaxke.elementarrows.forge.v1800.dispenser;
...
import me.cybermaxke.elementarrows.forge.v1800.entity.FEntityArrow;
...
public class DispenseElementArrow extends BehaviorProjectileDispense {
	...
	public ItemStack dispenseStack(IBlockSource source, ItemStack itemStack) {
		...
		if (arrow0 != null) {
			...
			EnumFacing face = BlockDispenser.getFacing(source.getBlockMetadata());
