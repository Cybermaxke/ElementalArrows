...
import static me.cybermaxke.elementarrows.forge.v1800.FLoadingPlugin.Obfuscated;
...
public class RenderClassTransformer implements IClassTransformer {
	...
	private static final String obfuscatedEntity = "wv";
	private static final String obfuscatedEntityLivingBase = "xm";
	private static final String obfuscatedModelBase = "ccq";
	private static final String obfuscatedRendererLivingEntity = "cqv";
	private static final String obfuscatedRender = "cpu";
	...
	private static final String deobfuscatedRenderLayers = "func_177093_a";

	private static final String obfuscatedDoRender = "a";
	private static final String obfuscatedRenderModel = "a";
	private static final String obfuscatedRenderLayers = "a";
	...
	private static final String obfuscatedMainModel = "f";
	...
	String mRenderLayers = Obfuscated ? obfuscatedRenderLayers : deobfuscatedRenderLayers;
	...
	class RenderClassVisitor extends ClassVisitor {
	    ...
	    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
			if (name.equals(mRenderLayers) && desc.equals("(L" + cEntityLivingBase + ";FFFFFFF)V")) {
				return new RenderMethodVisitorCall3(this.cv.visitMethod(access, name, desc, signature, exceptions));
			} else if (name.equals(mDoRender) && desc.equals("(L" + cEntityLivingBase + ";DDDFF)V")) {
		...
		class RenderMethodVisitorCall1 extends MethodVisitor {
			...
			public void visitCall1() {
				...
				super.visitMethodInsn(Opcodes.INVOKESTATIC, "me/cybermaxke/elementarrows/forge/v1800/render/RenderCallbackManagerBase", "call0", "(L" + cRender + ";L" + cEntity + ";DDDFF)V", false);
			}
		...
		class RenderMethodVisitorCall2 extends MethodVisitor {
			...
			public void visitCall2() {
				...
				super.visitMethodInsn(Opcodes.INVOKESTATIC, "me/cybermaxke/elementarrows/forge/v1800/render/RenderCallbackManagerBase", "call1", "(L" + cRender + ";L" + cEntity + ";L" + cModelBase + ";FFFFFF)V", false);
			}

		}

		class RenderMethodVisitorCall3 extends MethodVisitor {

			public RenderMethodVisitorCall3(MethodVisitor mv) {
				super(Opcodes.ASM4, mv);
			}
			...
			public void visitCall() {
				...
				super.visitVarInsn(Opcodes.FLOAD, 7);
				super.visitVarInsn(Opcodes.FLOAD, 8);
				super.visitMethodInsn(Opcodes.INVOKESTATIC, "me/cybermaxke/elementarrows/forge/v1800/render/RenderCallbackManagerBase", "call2", "(L" + cRender + ";L" + cEntity + ";FFFFFFF)V", false);
			}
