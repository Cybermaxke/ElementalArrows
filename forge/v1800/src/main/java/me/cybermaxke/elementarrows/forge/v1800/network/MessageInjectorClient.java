 ...
 */
package me.cybermaxke.elementarrows.forge.v1800.network;
...
import me.cybermaxke.elementarrows.forge.v1800.FElementArrows;
...
import me.cybermaxke.elementarrows.forge.v1800.util.Mods;
...
public class MessageInjectorClient {
	...
	public void onClientPlayerMPJoinWorld(EntityJoinWorldEvent event) {
		if (event.entity instanceof EntityPlayerSP) {
			this.onJoinWorld((EntityPlayerSP) event.entity);
			...
			((EntityPlayerSP) event.entity).sendQueue.addToSendQueue(packet);
		}
	}
	 ...
	 */
	private void onJoinWorld(EntityPlayerSP player) {
	...
	static class Handler extends ChannelDuplexHandler {
		...
		public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
			if (msg instanceof S3FPacketCustomPayload) {
				...
				if (msg0.getChannelName().equals("elementArrowsEntProps")) {
					PacketBuffer buffer = msg0.getBufferData();
