...
@IFMLLoadingPlugin.TransformerExclusions("me.cybermaxke.elementarrows.forge.v1800.render.RenderClassTransformer")
public class FLoadingPlugin implements IFMLLoadingPlugin {
	...
	public String[] getASMTransformerClass() {
		return new String[] { "me.cybermaxke.elementarrows.forge.v1800.render.RenderClassTransformer" };
	}
