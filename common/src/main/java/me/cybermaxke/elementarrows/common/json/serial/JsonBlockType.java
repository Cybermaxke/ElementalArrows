...
public class JsonBlockType implements JsonSerial<BlockType> {

	@Override
	public JsonElement serialize(BlockType src, Type type, JsonSerializationContext ctx) {
		return new JsonPrimitive(src.getId());
	}

	@Override
	public BlockType deserialize(JsonElement json, Type type, JsonDeserializationContext ctx) throws JsonParseException {
		String id = json.getAsString();
		BlockType type0 = Blocks.typeById(id);
